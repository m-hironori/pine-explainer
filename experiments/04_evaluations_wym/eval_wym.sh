...
PYTHONPATH=/workspaces/entity-matching-explainer/wym:/workspaces/entity-matching-explainer \
    ...
    nohup bash -c 'papermill  \
              ...
              >eval_wym_${TARGET_DATASET_ID}_${TOP_N}.log 2>&1 &' >/dev/null
...
PYTHONPATH=/workspaces/entity-matching-explainer/wym:/workspaces/entity-matching-explainer \
    TARGET_DATASET_ID=6 TOP_N=5 GPU_ID=3 \
    nohup bash -c 'papermill  \
              --prepare-execute --log-output \
              -p TARGET_DATASET_ID ${TARGET_DATASET_ID} -p TOP_N ${TOP_N} -p GPU_ID ${GPU_ID}\
              eval_wym.ipynb eval_wym_${TARGET_DATASET_ID}_${TOP_N}.ipynb \
...
PYTHONPATH=/workspaces/entity-matching-explainer/wym:/workspaces/entity-matching-explainer \
    TARGET_DATASET_ID=9 TOP_N=5 GPU_ID=1 \
    nohup bash -c 'papermill  \
              --prepare-execute --log-output \
              -p TARGET_DATASET_ID ${TARGET_DATASET_ID} -p TOP_N ${TOP_N} -p GPU_ID ${GPU_ID}\
              eval_wym.ipynb eval_wym_${TARGET_DATASET_ID}_${TOP_N}.ipynb \
...
PYTHONPATH=/workspaces/entity-matching-explainer/wym:/workspaces/entity-matching-explainer \
    TARGET_DATASET_ID=11 TOP_N=5 GPU_ID=0 \
    nohup bash -c 'papermill  \
              --prepare-execute --log-output \
              -p TARGET_DATASET_ID ${TARGET_DATASET_ID} -p TOP_N ${TOP_N} -p GPU_ID ${GPU_ID}\
              eval_wym.ipynb eval_wym_${TARGET_DATASET_ID}_${TOP_N}.ipynb \
